package ru.vood.flink.enrichment.perfomance

import org.scalatest.flatspec.AnyFlatSpec
import play.api.libs.json.Json
import ru.vood.flink.enrichment.perfomance.ExtractPerformanceTest.{inJsonStrValid, packageServiceInDto}
import ru.vood.flink.enrichment.perfomance.NodeTest.metaJsonProperty
import ru.vood.flink.enrichment.utils.config.enrich.flat.json.NodeJsonMeta
