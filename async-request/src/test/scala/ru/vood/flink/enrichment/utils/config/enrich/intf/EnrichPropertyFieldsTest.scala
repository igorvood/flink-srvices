...
import ru.vood.flink.enrichment.utils.config.enrich.intf.EnrichPropertyFieldsTest._
import ru.vood.flink.enrichment.utils.config.enrich.{EnrichFields, KeySelectorProp}
