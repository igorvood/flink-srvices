...
import ru.vood.flink.common.mask.dto.{JsMaskedPathObject, JsNumberMaskedPathValue, JsStringMaskedPathValue}
import ru.vood.flink.common.mask.fun.{NumberMaskAll, StringMaskAll}
...
class PathExtensionTest extends AnyFlatSpec with should.Matchers {
  ...
  "single transform str to JPath " should " OK" in {
    ...
    val paths = Map("f1.o1.d1" -> "ru.vood.flink.common.mask.fun.StringMaskAll")
  ...
  "two transform not cross str to JPath " should " OK" in {
    ...
    val paths = Map(
      "f1.o1.d1" -> "ru.vood.flink.common.mask.fun.StringMaskAll",
      "f2.o1.d1" -> "ru.vood.flink.common.mask.fun.NumberMaskAll")
      .map(q => MaskedStrPathWithFunName(q._1, q._2))
      .toJsonPath()
  ...
  "two with cross path transform str to JPath " should " OK" in {
    val paths = Map(
      "f1.o1.d1" -> "ru.vood.flink.common.mask.fun.StringMaskAll",
      "f1.o1.d2" -> "ru.vood.flink.common.mask.fun.StringMaskAll",
      //      "f1.o1.d3",
      //      "f2.o2.d3",
    )
      .map(q => MaskedStrPathWithFunName(q._1, q._2))
  ...
  "two with across error register object " should " OK" in {
    val paths1 = Map(
      "f1.o1.d1" -> "ru.vood.flink.common.mask.fun.StringMaskAll",
      "f1.o1.d1.q1" -> "ru.vood.flink.common.mask.fun.StringMaskAll",
    )
      .map(q => MaskedStrPathWithFunName(q._1, q._2))
