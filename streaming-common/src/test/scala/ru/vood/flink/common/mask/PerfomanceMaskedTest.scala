...
class PerfomanceMaskedTest extends AnyFlatSpec with should.Matchers {
  ...
  "mask all existing fields " should " OK" in {
    ...
    val path = Map(
      "dataString.serName" -> "ru.vood.flink.common.mask.fun.NameMaskService",
      "dataString.name" -> "ru.vood.flink.common.mask.fun.NameMaskService",
      "dataString.secondName" -> "ru.vood.flink.common.mask.fun.NameMaskService",
      "dataString.passportNum" -> "ru.vood.flink.common.mask.fun.PassportNumberInStrMaskService",
      "dataString.passportDepartment" -> "ru.vood.flink.common.mask.fun.PassportDepartmentMaskService",
      "dataString.phoneNum" -> "ru.vood.flink.common.mask.fun.PhoneStrMaskService",
      "dataString.address" -> "ru.vood.flink.common.mask.fun.AddressMaskService"
    )
