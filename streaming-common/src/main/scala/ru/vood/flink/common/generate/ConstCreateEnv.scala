...
import ru.vood.flink.common.generate.dto.{PlaceholderDto, Profile, StandDTO}
import ru.vood.flink.common.generate.dto.{CreationEnvProp, PlaceholderDto, Profile, StandDTO}
