package ru.vood.flink.common.mask.dto

import play.api.libs.json.JsValue
import ru.vood.flink.common.mask.fun.{JsBooleanMaskedFun, JsNumberMaskedFun, JsStringMaskedFun, MaskedFun}
import ru.vood.flink.common.mask.MaskedPredef.PathFactory
import ru.vood.flink.common.mask.MaskedStrPathWithFunName
import ru.vood.flink.common.mask.fun.{JsBooleanMaskedFun, JsNumberMaskedFun, JsStringMaskedFun, MaskedFun}
import ru.vood.flink.common.utils.config.PropertyUtil.asMap
 ...
 * prf.f1.d2.g3=ru.vood.flink.common.mask.fun.PassportDepartmentMaskService
 * prf.f2.d3.g4=ru.vood.flink.common.mask.fun.PassportDepartmentMaskService
