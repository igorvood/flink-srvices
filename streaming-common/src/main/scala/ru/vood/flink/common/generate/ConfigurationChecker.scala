...
import ru.vood.flink.common.generate.dto.{CreationEnvProp, Profile, Prop, StandDTO}
import ru.vood.flink.common.utils.config.{AllApplicationProperties, ConfigUtils, ConfigurationInitialise}
import ru.vood.flink.common.generate.ConstCreateEnv.{generatorPropList, placeholders, rootFolder}
import ru.vood.flink.common.generate.dto._
import ru.vood.flink.common.utils.config.{AllApplicationProperties, ConfigUtils, ConfigurationInitialise}
